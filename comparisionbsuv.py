...
def process_folder(pred_folder, gt_folder):
    ...
    with open('I:\\Werkstudenten\\Deepak_Raj\\DATASETS\\Metrics_final\\bsuvnet\\PETS2001dataset1camera2.txt', 'w') as file:
        for metric_name, value in average_metrics.items():
            file.write(f"{metric_name}: {value}\n")

    return average_metrics

pred_folder = r'I:\Werkstudenten\Deepak_Raj\DATASETS\Results_all_models_final\bsuvnet\PETS2001dataset1camera2'
gt_folder = r'I:\Werkstudenten\Deepak_Raj\DATASETS\Private\GT\PETS2001dataset1camera2'
